<h1>Welcome to the TanStack Query in SvelteKit Tutorial!</h1>

<p>
	This project demonstrates how to use TanStack Query for data fetching, mutations, and more in a
